const CACHE="phoenix-pdf2epub-v2.0.0";
const ASSETS=["./","index.html","style.css","app.js","manifest.webmanifest","pdf.min.js","pdf.worker.min.js","jszip.min.js","icon-192.png","icon-512.png"];
